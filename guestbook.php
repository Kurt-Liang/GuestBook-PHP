			...
			<div id="header" class="container">
				...
				<div id="menu">
					<ul>
						...
						<li class="current_page_item"><a href="guestbook.php">Guestbook</a></li>
					...
					<div class="post">
						<div class="post-bgtop">
							<div class="post-bgbtm">
								<h2 class="title"><a href="#">Leave a message</a></h2>
								<?php
								if (isset($_SESSION['userName'])) {
									echo "<form class='form' action='action.php', method='post'>
